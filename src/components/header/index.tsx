...
const Header = () => {
  // custom hook
  const { handleThemeToggle, mode } = useTheme();
  ...
  return (
    <header className="bg-card flex items-center justify-between rounded-t-lg border-b-2 p-4">
      ...
      <h1 className="text-base font-medium">
        <Link
          href="/"
          className="logo focus:ring-primary rounded focus:ring-2 focus:ring-offset-2 focus:outline-none"
          aria-label="Review Screen - Home"
        >
          Review Screen
        </Link>
      </h1>
      ...
      <div className="flex gap-2">
        ...
        >
          <Link
            href="https://github.com/jenishshrestha/doc-task/"
            target="_blank"
